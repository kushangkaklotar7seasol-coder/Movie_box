...
final class CompassManager: NSObject, ObservableObject, CLLocationManagerDelegate {
   ...
   static func longDirection(for heading: Double) -> String {
       let dirs = [Strings.north, Strings.northest, Strings.northest, Strings.easthNorthest,
                   Strings.east, Strings.eastSouthest, Strings.southest, Strings.southest,
                   Strings.south, Strings.southSouthwest, Strings.southWest, Strings.westSouthWest,
                   Strings.west, Strings.westNorthWest, Strings.northWest, Strings.northNorthWest]
       return dirs[compassIndex(for: heading)]
   }
}
